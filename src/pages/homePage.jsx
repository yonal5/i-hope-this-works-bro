        ...
        <div className="w-full bg-gray-50 py-24 px-4">
          <div className="max-w-7xl mx-auto">
            ...
            <div className="mt-24 grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
              <img src="/eeee.jpg" alt="Professional website design" className="w-full rounded-3xl shadow-lg" />
            ...
            <div className="mt-24 grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
              ...
              <img src="/eee.jpg" alt="Website performance and analytics" className="w-full rounded-3xl shadow-lg" />
            </div>
